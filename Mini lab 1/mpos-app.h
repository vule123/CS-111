 ...
 *
 *   Create a new process in a thread-like way. The new process starts with an 
 *  empty stack. The new thread starts by executing the start_function function.
 *
 *   Return the new thread's process ID.
 *
 *****************************************************************************/
 ...
 * sys_kill(pid)
 *
 *   Force the process having this pid to exit.
 *
